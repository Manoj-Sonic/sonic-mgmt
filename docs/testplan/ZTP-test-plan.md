...
```
{
  "ztp": {
    "01-configdb-json": {
    "url": {
      "source": "http://<ipv4-ztp-server>/sonic_config_db.json",
...
```
{
  "ztp": {
   ...
   "03-provisioning-script": {
      "plugin": {
        "url":"http://<ipv4-ztp-server>/post_install.sh"
      },
...
```
{
  "ztp": {
    "01-configdb-json": {
    "url": {
      "source": "ftp://<ipv4-ztp-server>/sonic_config_db.json",
      "destination": "/etc/sonic/config_db.json"
     }
    }
  }
...
```
{
  "ztp": {
   ...
   "03-provisioning-script": {
      "plugin": {
        "url":"ftp://<ipv4-ztp-server>/post_install.sh"
      },
      "reboot-on-success": true
    }
  }
...
```
{
  "ztp": {
    "01-configdb-json": {
    "url": {
      "source": "https://<ipv4-ztp-server>/sonic_config_db.json",
      "destination": "/etc/sonic/config_db.json"
     }
    }
  }
...
```
{
  "ztp": {
   ...
   "03-provisioning-script": {
      "plugin": {
        "url":"https://<ipv4-ztp-server>/post_install.sh"
      },
      "reboot-on-success": true
    }
  }
